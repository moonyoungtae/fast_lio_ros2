...
void Preprocess::avia_sim_handler(const sensor_msgs::msg::PointCloud2::UniquePtr &msg)
{
  ...
  for (int i = 0; i < pl_orig.points.size(); i++)
  {
    ...
    added_pt.intensity = 100.0;
    added_pt.normal_x = 0;
    added_pt.normal_y = 0;
    added_pt.normal_z = 0;
    added_pt.curvature = 0.0;  // curvature unit: ms
